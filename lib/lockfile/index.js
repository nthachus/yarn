...
function explodeEntry(pattern, obj) {
  ...
  if (integrity && integrity.isIntegrity) {
    obj.integrity = (0, _ssri.parse)(integrity);
  }
  return obj;
}
...
class Lockfile {
  ...
  static fromDirectory(dir, reporter) {
    ...
    var lockfileLoc = _path.default.join(dir, _constants.LOCKFILE_FILENAME);
  ...
  getLockfile(patterns) {
    ...
    for (var pattern of sortedPatternsKeys) {
      ...
      (0, _invariant.default)(ref, 'Package is missing a reference');
      (0, _invariant.default)(remote, 'Package is missing a remote');
