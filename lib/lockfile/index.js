...
exports.stringify = _stringify.default;
...
class Lockfile {
  constructor(_temp) {
    var _ref = _temp === void 0 ? {} : _temp, cache = _ref.cache, source = _ref.source, parseResultType = _ref.parseResultType;
  ...
  static fromDirectory(dir, reporter) {
    return (0, _asyncToGenerator2.default)(function* () {
      ...
      if (yield fs.exists(lockfileLoc)) {
        rawLockfile = yield fs.readFile(lockfileLoc);
